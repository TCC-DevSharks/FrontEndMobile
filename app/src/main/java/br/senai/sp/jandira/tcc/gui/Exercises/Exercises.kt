package br.senai.sp.jandira.tcc.gui.Exercises
            ...
            Card(
                ...
                Row(modifier = Modifier
                    ...
                    Column(horizontalAlignment = Alignment.CenterHorizontally, verticalArrangement = Arrangement.Center) {
                        Image(
                                painter = painterResource(id = R.drawable.pe), contentDescription = null, modifier = Modifier
                                .size(145.dp)
                                .padding(20.dp)
                        )
                    }
            ...
            Card(
                ...
                Row(modifier = Modifier.fillMaxSize().padding(horizontal = 12.dp), verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.SpaceBetween) {
                    ...
                    Row (verticalAlignment = Alignment.CenterVertically) {
                        ...
                        Column (verticalArrangement = Arrangement.Center, modifier = Modifier.fillMaxHeight().padding(start = 5.dp)) {
                            Text(
