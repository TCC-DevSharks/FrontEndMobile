package br.senai.sp.jandira.tcc.gui.mobileDoctor.flowNutrition.defaultMeal.changeFoodDefault
...
fun AddFoodToDefaultMeal(navController: NavController, modelFood: ModelFood) {
    ...
    LaunchedEffect(effect){
        ...
        val callFilter = RetrofitFactory().food().getFoodMealDefault(modelFood.refeicao)
